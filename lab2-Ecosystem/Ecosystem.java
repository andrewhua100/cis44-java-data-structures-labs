...
public class Ecosystem {
    ...
    public Ecosystem(int riverSize) {
        ...
        for(int i = 0;i<riverSize;i++){
            //Randomly chooses whether the animal in the cell is a fish, a bear, or empty
    ...
    public void runStep(int riverSize) {
        ...
        int n; //direction the animal moves(-1, 0, 1)
        Animal current;
        int bcount = 0; //number of new bears
        int fcount = 0; //number of new fishes
        for(int i = 0;i<riverSize;i++){
            current = river[i];
            //If river is empty at current index
            if(current==null){
                continue;
            }
            //if index is at left bound or right bound
            if(i == 0){
                n = random.nextInt(2);
            }
        ...
        //counts the number of empty cells in the river after the step
        int emptycount = 0;
        for(int i = 0;i<riverSize;i++){
            if(newE[i]==null){
                emptycount++;
        ...
        int randomm = 0;
        int empty = 0;
        //For each new fish, puts it in a random empty cell.
        ...
        empty = 0;
        //For each new bear, puts it in a random empty cell.
